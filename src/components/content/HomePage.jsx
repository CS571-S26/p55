			...
			<Container className="tripgenie-home-container">
				<Row className="justify-content-center align-items-center min-vh-100">
					<Col md={8} lg={6} className="text-center">
						<img src={require('../../assets/logo.png')} alt="TripGenie Logo" className="tripgenie-logo mb-4" />
						<h1 className="tripgenie-title">Welcome to TripGenie</h1>
						<p className="tripgenie-subtitle mb-4">
							Your AI-powered trip planner. Effortlessly create, customize, and optimize your travel adventures with the magic of artificial intelligence.
						</p>
